...
//    public Result downloadExcelPaper() {
//        Form<Paper> paperForm = formFactory.form(Paper.class).bindFromRequest();
//        Paper paperInfo = paperForm.get();
//        String status = paperInfo.status;
//        Paper paperInfo = new Paper();
...
//        List<Paper> res = new ArrayList<Paper>();
//
//        return resofrest.thenAccpet(response -> {
//            System.out.println("here is "+response);
//            JsonNode arr = response.asJson();
//            ArrayNode ret = (ArrayNode) arr;
////            List<Paper> res = new ArrayList<Paper>();
...
//        }
//
//        try (FileOutputStream outputStream = new FileOutputStream("allpaper.xls")) {
...
//
//
//    public CompletionStage<Result> downloadAcceptedPaper() {
//        Form<Paper> paperForm = formFactory.form(Paper.class).bindFromRequest();
//        Paper paperInfo = paperForm.get();
//        String status = paperInfo.status;
//        Paper paperInfo = new Paper();
...
//        List<Paper> res = new ArrayList<Paper>();
//
//        return resofrest.thenAccept(response -> {
//            System.out.println("here is "+response);
//            JsonNode arr = response.asJson();
//            ArrayNode ret = (ArrayNode) arr;
//            for(JsonNode res1 : ret){
...
//        }
//
//        try (FileOutputStream outputStream = new FileOutputStream("paper.xls")) {
//            workbook.write(outputStream);
//        }
//
//        System.out.println("downloading...");
